...
/* package red-0.1.0.0 */
#ifndef VERSION_red
#define VERSION_red "0.1.0.0"
#endif /* VERSION_red */
#ifndef MIN_VERSION_red
#define MIN_VERSION_red(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_red */
...
#define CURRENT_COMPONENT_ID "red-0.1.0.0-inplace-redis-recommender"
